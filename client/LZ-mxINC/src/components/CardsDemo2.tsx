...
import logo12 from "../assets/company_logos/The Supplies Saver Logo.png";
...
import img121 from "../assets/company_pictures/The Supplies Saver 1.png";
...
const CardsDemo2 = ({
  ...
  useEffect(() => {
    console.log("Product Amount Available:", productAmountAvailable);
    updateProductAmountAvailable();
  }, [updateProductAmountAvailable]);
